...
//public class UploadController_orginalll {
//
...
//	
//	private static final Logger logger = LoggerFactory.getLogger(UploadController_orginalll.class);
//	
//	// AWS s3 
...
//		
//	logger.info("파일 겟오리날네임"+file.getOriginalFilename());
