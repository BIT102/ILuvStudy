...
<body>
     ...
     <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
          <a class="navbar-brand js-scroll-trigger" href="/study/main">I Luv Study</a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="/study/listAll">스터디 구경하기</a>
              </li>
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="/study/register1">스터디등록</a>
              </li>
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="/sqna/list">FAQ</a>
              </li>
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="/study/notice">공지사항</a>
              </li>
            </ul>
          </div>
        </div>
