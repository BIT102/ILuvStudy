...
<%@ include file="nav.jsp" %>
	...
	<form role="form" method="post">
        ...
        <tbody>
            ...
            <tr>
                <th>내용</th>
                <td><textarea id="summernote" name="content" class="form-control" style="height:100%; resize: none;">${qnaVO.content}</textarea></td>
            </tr>
            <tr>
                <th>공개여부</th>
                <td>
...
<script>
	$(document).ready(function(){
		...
		$("#registerBtn").on("click", function(){
			...
			if(document.getElementById("summernote").value.length >= 5){
				formObj.submit();
			}else{
